  ...
  return (
    <div className="flex items-center">
      <svg viewBox="0 0 190 46" height="34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="94" y="41" fontFamily="'Syne', sans-serif" fontWeight="600" fontSize="16" letterSpacing="3" fill="#0D0D0D" opacity="0.75">ONLINE</text>
      </svg>
    </div>
  );
}
            ...
            {games.map((game) => (
              ...
              >
                ...
                <div className="p-3 flex flex-col flex-1">
                  ...
                  {game.id !== "xadrez" && game.id !== "bilhar" && <p className="text-[10px] text-slate-400 mt-0.5 mb-3">{formatPlayerCount(getLivePlayerCount(game.baseIdx, tick))} jogando</p>}
            ...
            {topGames.map((game) => (
              ...
              >
                ...
                <div className="ml-3 flex-1 min-w-0">
                  ...
                  {game.id !== "xr" && game.id !== "bi" && <p className="text-[10px] text-slate-400 mt-0.5">{formatPlayerCount(getLivePlayerCount(game.baseIdx, tick))} apostadores ativos</p>}
                </div>
