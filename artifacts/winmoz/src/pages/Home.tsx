...
function WinMozLogo() {
  return (
    <div className="flex items-center">
      <svg viewBox="0 0 134 46" height="34" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 2 L11 2 L7 44 L0 44 Z" fill="#0D0D0D"/>
        <path d="M13 2 L20 2 L16 44 L10 44 Z" fill="#0D0D0D" opacity="0.18"/>
        <text x="23" y="27" fontFamily="'Syne', sans-serif" fontWeight="800" fontSize="22" letterSpacing="-0.5" fill="#0D0D0D">WinMoz</text>
        <text x="23" y="41" fontFamily="'Syne', sans-serif" fontWeight="300" fontSize="12" letterSpacing="2.5" fill="#0D0D0D">APOSTAS</text>
      </svg>
    </div>
  );
}
