...
export default function EsqueceuSenha() {
  ...
  const handleSubmit = () => {
    if (email.trim()) {
      setLocation(`/otp?email=${encodeURIComponent(email)}`);
    }
  };
    ...
    <div className="min-h-screen bg-white w-full flex justify-center">
      <div className="w-full max-w-[430px] min-h-screen bg-white flex flex-col px-6 pt-16 pb-10 relative">
        ...
        >
          ...
          >
            <Mail style={{ width: 26, height: 26, color: "#111" }} />
          </div>
          ...
          <div className="mb-7">
            ...
            <input
              ...
              style={{
                ...
                padding: "15px 16px",
                borderRadius: 0,
                border: focused ? "1.5px solid #000" : "1px solid #d1d5db",
                background: "#ffffff",
                fontSize: 14,
                color: "#111",
                outline: "none",
          ...
          <button
            ...
            onMouseEnter={e => { if (email.trim()) e.currentTarget.style.opacity = "0.88"; }}
            onMouseLeave={e => { if (email.trim()) e.currentTarget.style.opacity = "1"; }}
          >
